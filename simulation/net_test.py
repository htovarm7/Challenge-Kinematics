...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["server", "client"], required=True, help="Modo de ejecución")
    parser.add_argument("--ip", default="127.0.0.1", help="IP del servidor (solo en modo cliente)")
